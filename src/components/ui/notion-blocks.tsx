...
import { NOTION_COLOR_MAP, renderRichText } from "./notion-rich-text";
...
function NotionImage({ src, alt }: { src: string; alt: string }) {
  ...
  if (hasError) {
    return (
      <div className="m-auto flex h-[200px] max-w-full items-center justify-center rounded-[2px] bg-gray-100 text-gray-400">
        <svg
          className="h-12 w-12"
          fill="none"
          stroke="currentColor"
